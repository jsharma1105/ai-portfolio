...
const TechStack = () => {
  ...
  useEffect(() => {
    ...
    const clickCleanups: Array<[HTMLElement, () => void]> = [];
    document.querySelectorAll(".header a").forEach((elem) => {
      ...
      clickCleanups.push([element, onClick]);
    });
    window.addEventListener("scroll", handleScroll);
    return () => {
      window.removeEventListener("scroll", handleScroll);
      clickCleanups.forEach(([el, fn]) => el.removeEventListener("click", fn));
    };
  }, []);
